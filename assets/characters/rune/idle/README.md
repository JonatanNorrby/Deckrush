...
Looping combat idle. Plays while the character is waiting for input. The first frame, `1.png`, is also used as Rune's main-menu and character-selection artwork.
