# Score Leech — damage animation

Plays whenever this enemy loses HP, including card damage and Poison damage.
...
- Keep every frame on the same canvas size and keep Score Leech aligned consistently.
- If `1.png` is missing, the game uses its CSS fallback animation instead.

Expected path example:

`assets/enemies/parasite/damage/1.png`
