# The Auditor — damage animation

Plays whenever The Auditor loses HP, including card damage and Poison damage.
...
- Keep every frame on the same canvas size and keep The Auditor aligned consistently.
- If `1.png` is missing, the game uses its CSS fallback animation instead.

Expected path example:

`assets/enemies/auditor/damage/1.png`
